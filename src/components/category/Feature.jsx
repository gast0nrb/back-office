    ...
    return(
        <>
            <div className="mx-auto text-center bg-neutral-200 w-11/12 my-2 rounded-xs">
                ...
                <div className="flex justify-center gap-0.5 px-1 border-neutral-400">
                    <input className="text-center border-1 border-neutral-400 bg-neutral-200 rounded-xs my-1 w-11/12" type="text" value={value}/>
