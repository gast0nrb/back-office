        ...
        <td className="w-5 mx-auto">
          <a href="/producto">
            <img
              src="/file.svg"
              alt="ver producto"
              className="mx-auto md:mt-0 xs:mt-2 w-5"
            />
          </a>
        </td>
      </tr>
